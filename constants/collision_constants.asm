...
COLL_DIAGONAL_STAIRS_DOWN_RIGHT EQU $d0
COLL_DIAGONAL_STAIRS_DOWN_LEFT  EQU $d1
COLL_DIAGONAL_STAIRS_UP_RIGHT   EQU $e0
COLL_DIAGONAL_STAIRS_UP_LEFT    EQU $e1
...
HI_NYBBLE_DIAGONAL_STAIRS_DOWN  EQU $d0
HI_NYBBLE_DIAGONAL_STAIRS_UP    EQU $e0
