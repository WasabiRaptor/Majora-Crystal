...
; Johto story events
	...
	const EVENT_CLEARED_TREVENANT_WELL
	...
	const EVENT_GOT_KINGS_ROCK_IN_TREVENANT_WELL
...
; More Johto story events
	...
	const EVENT_LEARNED_TREVENANTTAIL
...
; Johto itemballs
	...
	const EVENT_TREVENANT_WELL_B1F_SUPER_POTION
	const EVENT_TREVENANT_WELL_B2F_TM_RAIN_DANCE
...
; Johto people
	...
	const EVENT_AZALEA_TOWN_TREVENANTS
	const EVENT_AZALEA_TOWN_TREVENANTTAIL_ROCKET
	const EVENT_TREVENANT_WELL_TREVENANTS
	const EVENT_TREVENANT_WELL_ROCKETS
	const EVENT_KURTS_HOUSE_TREVENANT
	...
	const EVENT_TREVENANT_WELL_KURT ; 740
