...
; Johto story events
	...
	const EVENT_CLEARED_TREVANANT_WELL
	...
	const EVENT_GOT_DUSKULL_FROM_KIYO
	...
	const EVENT_GOT_KINGS_ROCK_IN_TREVANANT_WELL
...
; Kanto hidden items
	const EVENT_MIENFOOS_CAVE_HIDDEN_MAX_REVIVE
...
; MajoraCrystal Events that have since gone unused and replaced
	...
	const EVENT_ITS_GETTING_CLOSER
	const EVENT_ITS_RIGHT_NEAR
;???
	const EVENT_10A
	const EVENT_10B
	const EVENT_10C
...
; More Johto story events
	...
	const EVENT_LEARNED_TREVANANTTAIL
	const EVENT_LEARNED_PORYGONZ_TAIL
	...
	const EVENT_SHOWED_KROOKODILE_TO_BILLS_GRANDPA
	const EVENT_SHOWED_NIDOQUEEN_TO_BILLS_GRANDPA
	const EVENT_SHOWED_GENGAR_TO_BILLS_GRANDPA
	const EVENT_SHOWED_LUXRAY_GRIMER_TO_BILLS_GRANDPA
	const EVENT_SHOWED_KOMMO_O_TO_BILLS_GRANDPA
...
; Johto itemballs
	...
	const EVENT_TREVANANT_WELL_B1F_SUPER_POTION
	const EVENT_TREVANANT_WELL_B2F_TM_RAIN_DANCE
...
; Johto people
	const EVENT_RIVAL_STARTING_TOWN
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_SHIINOTIC_1
	const EVENT_TEAM_ROCKET_BASE_B2F_SHIINOTIC_2
	const EVENT_TEAM_ROCKET_BASE_B2F_SHIINOTIC_3
	...
	const EVENT_CHARCOAL_KILN_STUFFUL
	const EVENT_CHARCOAL_KILN_APPRENTICE
	const EVENT_CHARCOAL_KILN_BOSS
	const EVENT_ROUTE_36_SUDOWOODO
	const EVENT_AZALEA_TOWN_TREVANANTS
	const EVENT_AZALEA_TOWN_TREVANANTTAIL_ROCKET
	const EVENT_TREVANANT_WELL_TREVANANTS
	const EVENT_TREVANANT_WELL_ROCKETS
	const EVENT_KURTS_HOUSE_TREVANANT
	...
	const EVENT_TREVANANT_WELL_KURT ; 740
