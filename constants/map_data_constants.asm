...
; FishGroups indexes (see data/wild/fish.asm)
	...
	const FISHGROUP_HITMONCHAN
	const FISHGROUP_PILOSWINE_SWARM
	const FISHGROUP_BRONZOR_SWARM
	const FISHGROUP_GYARADOS
	const FISHGROUP_HITMONCHAN_2
	const FISHGROUP_WHIRL_ISLANDS
	const FISHGROUP_PILOSWINE
	const FISHGROUP_BRONZOR
	const FISHGROUP_PILOSWINE_NO_SWARM
