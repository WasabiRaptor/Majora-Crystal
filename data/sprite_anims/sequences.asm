...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_SLOTS_FOONGUS,              SPRITE_ANIM_SEQ_SLOTS_FOONGUS,             $07 ; SPRITE_ANIM_INDEX_SLOTS_FOONGUS
	db SPRITE_ANIM_FRAMESET_SLOTS_GOOMY,            SPRITE_ANIM_SEQ_SLOTS_GOOMY,           $07 ; SPRITE_ANIM_INDEX_SLOTS_GOOMY
