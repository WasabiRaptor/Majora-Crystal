...
.JohtoStarters: db BUENA_MON,    10, ABOMASNOW, TOTODILE, CHIKORITA
...
.Pokemon1:      db BUENA_MON,    10, TOGEKISS, PORYGON2, COTTONEE
.Pokemon2:      db BUENA_MON,    10, TYRANITAR, SPINARAK, DROWZEE
