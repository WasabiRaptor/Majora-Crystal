...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  NIDORAN_M,     SET_UP_POSTER,     EVENT_DECO_POSTER_3,             $25
	...
	decoration DECO_DOLL,    NIDORAN_M,     SET_UP_DOLL,       EVENT_DECO_NIDORAN_M_DOLL,      SPRITE_NIDORAN_M
	decoration DECO_DOLL,    EEVEE,      SET_UP_DOLL,       EVENT_DECO_BULBASAUR_DOLL,       SPRITE_BULBASAUR
	decoration DECO_DOLL,    FLAREON,     SET_UP_DOLL,       EVENT_DECO_CHARMANDER_DOLL,      SPRITE_CHARMANDER
	decoration DECO_DOLL,    LEAFEON,       SET_UP_DOLL,       EVENT_DECO_SQUIRTLE_DOLL,        SPRITE_SQUIRTLE
	decoration DECO_DOLL,    SANDSLASH,        SET_UP_DOLL,       EVENT_DECO_SANDSLASH_DOLL,         SPRITE_SANDSLASH
	decoration DECO_DOLL,    MIENFOO,        SET_UP_DOLL,       EVENT_DECO_MIENFOO_DOLL,         SPRITE_MIENFOO
	...
	decoration DECO_DOLL,    NIDOQUEEN,         SET_UP_DOLL,       EVENT_DECO_NIDOQUEEN_DOLL,          SPRITE_NIDOQUEEN
	...
	decoration DECO_DOLL,    LYCANROC,         SET_UP_DOLL,       EVENT_DECO_WEEDLE_DOLL,          SPRITE_WEEDLE
