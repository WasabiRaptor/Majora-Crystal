...
KarenGroup:
	...
	db 42, UMBREONX,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
...
SabrinaGroup:
	...
	db 46, ESPEONX,     SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
...
RedGroup:
	...
	db 73, ESPEONX,     MUD_SLAP, REFLECT, SWIFT, PSYCHIC_M
