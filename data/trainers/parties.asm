...
FalknerGroup:
	...
	db  13, PIDGEY,     TACKLE, MUD_SLAP, GUST, NO_MOVE
...
BugsyGroup:
	...
	db 18, BEEDRILL,   POISON_STING, FURY_ATTACK, FOCUS_ENERGY, STRING_SHOT
...
Rival1Group:
	...
	db 24, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	...
	db 42, MAGNETON,   TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
