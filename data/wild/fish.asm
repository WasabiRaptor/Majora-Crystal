...
; entries correspond to FISHGROUP_* constants
	...
	fishgroup 50 percent + 1, .Hitmonchan_Old,          .Hitmonchan_Good,          .Hitmonchan_Super
	...
	fishgroup 50 percent + 1, .Hitmonchan_2_Old,        .Hitmonchan_2_Good,        .Hitmonchan_2_Super
...
TimeFishGroups:
	...
	db HITMONCHAN,    40,  HITMONCHAN,    40 ; 9
