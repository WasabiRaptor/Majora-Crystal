...
MapGroup_MysteryDungeon:
	...
	map MysteryDungeonNSEW, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_NSEW, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND

	map MysteryDungeonNSE, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_NSE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonNSW, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_NSW, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonNEW, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_NEW, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonSEW, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_SEW, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND

	map MysteryDungeonNS, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_NS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonEW, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_EW, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND

	map MysteryDungeonNE, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_NE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonNW, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_NW, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonSE, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_SE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonSW, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_SW, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND

	map MysteryDungeonN, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_N, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonS, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_S, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonE, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_E, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
	map MysteryDungeonW, TILESET_JOHTO, ROUTE, MYSTERY_DUNGEON_W, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_POND
