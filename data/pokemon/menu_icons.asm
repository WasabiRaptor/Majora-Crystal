...
MonMenuIcons:
	db ICON_BULBASAUR   ; EEVEE
	db ICON_BULBASAUR   ; VAPOREON
	db ICON_BULBASAUR   ; JOLTEON
	db ICON_CHARMANDER  ; FLAREON
	db ICON_CHARMANDER  ; ESPEON
	db ICON_BIGMON      ; UMBREON
	db ICON_SQUIRTLE    ; LEAFEON
	db ICON_SQUIRTLE    ; GLACEON
	db ICON_SQUIRTLE    ; SYLVEON
	db ICON_CATERPILLAR ; ZORUA
	db ICON_CATERPILLAR ; ZOROARK
	db ICON_MOTH        ; ROCKRUFF
	db ICON_CATERPILLAR ; LYCANROC
